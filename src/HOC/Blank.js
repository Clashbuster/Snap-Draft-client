...
render(){
    return(
        <div className="blankslate">
            <svg width="28" height="32" viewBox="0 0 14 16" className="octicon octicon-git-commit blankslate-icon" aria-hidden="true">
                <path
                fillRule="evenodd"
            ...
            <svg width="28" height="32" viewBox="0 0 14 16" className="octicon octicon-tag blankslate-icon" aria-hidden="true">
                <path
                fillRule="evenodd"
            ...
            <svg width="20" height="32" viewBox="0 0 10 16" className="octicon octicon-git-branch blankslate-icon" aria-hidden="true">
                <path
                fillRule="evenodd"
            ...
            <p>Perhaps you should start a new project or submit a sprint to an existing one</p>
        </div>
    )
}
